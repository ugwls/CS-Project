...
def add_dishwasher():
    try:
        ...
        s = 'insert into dish_washer (item_no, item_id, brand, model, quantity, price_per_unit, MRP)' \
...
def delete():
    try:
        ...
        s = 'DELETE FROM dish_washer WHERE item_id = %s'
        value = (item_id,)
        cur.execute(s, value)
        mydb.commit()
